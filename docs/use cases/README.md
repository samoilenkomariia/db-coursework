...
@startuml
    ...
    |Керівник команди|
    start
    :Заходить в розділ управління проєктами;
    |Система|
    :Перенаправляє керівника команди в розділ керування проектами;
    |Керівник команди|
    :Натискає кнопку "Створити новий проєкт";
    |Система|
    :Перенаправляє керівника команди на форму створення нового проєкту;
    |Керівник команди|
    :Вводить необхідні дані в поля для створення проєкту;
    ...
    :Повідомляє керівника команди про успішне створення проєкту;
    :Перенаправляє керівника команди на створений проєкт;
    stop
...
@startuml
    ...
    |Система|
    :Перенаправляє керівника команди на меню редагування проєкту;
    |Керівник команди|
    :Вводить необхідні дані в поля для редагування проєкту;
    ...
    :Запитує пітвердження змін;
    note right #lightcoral
        * Може виникнути <b>CancelException</b>
    end note
    |Керівник команди|
    :Натискає кнопку "Підтвердити зміни";
    |Система|
    :Оновлює дані проєкту;
    :Повідомляє керівника команди про успішне оновлення даних;
    :Перенаправляє керівника команди на сторінку оновленого проєкту;
    stop
