...
@startuml
    ...
    |Керівник команди|
    start
    :Керівник команди заходить в меня управління проєктами;
    |Система|
    :Система перенаправляє керівника команди на меню керування проектами;
    |Керівник команди|
    :Керівник команди натискає кнопку "Створити новий проєкт";
    |Система|
    :Система перенаправляє керівника команди на форму створення нового проєкту;
    |Керівник команди|
    :Керівник команди вводить необхідні дані;
    :Керівник команди натискає кнопку "Створити";
    note right #lightcoral
        * Може виникнути <b>InvalidDataException</b>
    end note
    |Система|
    :Система створює новий проєкт;
    :Система повідомляє керівника команди про успішне створення проєкту;
    :Система перенаправляє керівника команди на створений проєкт;
...
@startuml
    ...
    :Система перенаправляє керівника команди на меню керування проектами;
    |Керівник команди|
    :Керівник команди натискає кнопку "Редагувати проєкт";
    |Система|
    :Система перенаправляє керівника команди на меню редагування проєкту;
    |Керівник команди|
    :Керівник команди вводить необхідні дані;
    :Керівник команди натискає кнопку "Зберегти зміни";
    note right #lightcoral
        * Може виникнути <b>InvalidDataException</b>
    end note
    |Система|
    :Система запитує пітвердження змін;
    note right #lightcoral
        * Може виникнути <b>CancelException</b>
    end note
    |Керівник команди|
    :Керівник команди натискає кнопку "Підтвердити зміни";
    |Система|
    :Система оновлює дані проєкту;
    :Система повідомляє керівника команди про успішне оновлення даних;
    :Система перенаправляє керівника команди на сторінку оновленого проєкту;
    stop
