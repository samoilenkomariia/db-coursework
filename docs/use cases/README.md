...
@startuml
     ...
     |Керівник команди|
     :Натискає кнопку\n"Видалити користувача до проєкту";
   
     |Система|
     :Відкриває вікно зі списком\nусіх учасників проєкту\nта полем для пошуку\nза іменем користувача;
   
     |Керівник команди|
     :Знаходить потрібного користувача\nі натискає кнопку "Видалити";
   
     |Система|
     :Відкриває вікно з кнопками\n"Видалити користувача" та "Скасувати";
     note right#lightcoral
          Може виникнути
         <b> CancelException
     end note
...
@startuml
    ...
    |Система|
    :Виводить вікно для\nпідтвердження змін з\nкнопками "Скасувати" і "Зберегти зміни";
