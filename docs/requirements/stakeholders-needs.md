...
Цей документ визначає основні вимоги до продукту, які необхідно взяти до уваги при проєктування та розробці системи керування проєктами, а також надає характеристику ділових процесів, котра дозволить зацікавленим особам сформувати уявлення про взаємодію з продуктом.
