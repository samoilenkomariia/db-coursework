...
| Основний сценарій: | 1. Користувач відкриває проєкт <br> 2. Користувач натискає кнопку "Фільтри" <br> 3. Користувач обирає фільтри (може виникнути <font color="red">InvalidDataException</font>) <br> 4. Користувач натискає кнопку "Застосувати" <br> 7. Система відображає перелік завдань, відібраних за обраними фільтрами |
...
| Основний сценарій: | 1. Адміністратор відкриває проєкт <br> 2. Адміністратор натискає кнопку "Керування проєктом" <br> 3. Адміністратор натискає кнопку "Заблокувати" <br> 4. Система запитує вибір причини блокування та підтвердження операції блокування <br> 5. Адміністратор обирає причину блокування та підтверджує операцію блокування (може виникнути <font color="red">CancelException</font>) <br> 6. Система змінює стан проєкту на "Заблокований" <br> 7. Система сповіщає адміністратора про блокування проєкту <br> 8. Система сповіщає керівника команди про блокування проєкту |
...
| Основний сценарій: | 1. Адміністратор відкриває проєкт <br> 2. Адміністратор натискає кнопку "Керування проєктом" <br> 3. Адміністратор натискає кнопку "Розблокувати" <br> 4. Система запитує підтвердження операції розблокування <br> 5. Адміністратор підтверджує операцію розблокування (може виникнути <font color="red">CancelException</font>) <br> 6. Система змінює стан проєкту на "Розблокований" <br> 7. Система сповіщає адміністратора про розблокування проєкту <br> 8. Система сповіщає керівника команди про розблокування проєкту |
...
| Виключні ситуації: | - <font color="red">CancelException</font>: Адміністратор скасував операцію блокування |
| Основний сценарій: | 1. Адміністратор відкриває перелік активних користувачів системи <br> 2. Адміністратор натискає кнопку меню дій над користувачем <br> 3. Адміністратор натискає кнопку "Заблокувати" <br> 4. Система запитує вибір причини блокування та підтвердження операції блокування <br> 5. Адміністратор обирає причину блокування та підтверджує операцію блокування (може виникнути <font color="red">CancelException</font>) <br> 6. Система змінює стан облікового запису користувача на "Заблокований" <br> 7. Система сповіщає адміністратора про блокування користувача <br> 8. Система сповіщає користувача про блокування його облікового запису |
...
| Виключні ситуації: | - <font color="red">CancelException</font>: Адміністратор скасував операцію розблокування |
| Основний сценарій: | 1. Адміністратор відкриває перелік заблокованих користувачів системи <br> 2. Адміністратор натискає кнопку меню дій над користувачем <br> 3. Адміністратор натискає кнопку "Розблокувати" <br> 4. Система запитує підтвердження операції розблокування <br> 5. Адміністратор підтверджує операцію розблокування (може виникнути <font color="red">CancelException</font>) <br> 6. Система змінює стан облікового запису користувача на "Активний" <br> 7. Система сповіщає адміністратора про розблокування користувача <br> 8. Система сповіщає користувача про розблокування його облікового запису |
...
| Основний сценарій: | 1. Користувач натискає на кнопку "Користувацька підтримка" <br> 2. Система перенаправляє користувача на сторінку створення звернення <br> 5. Користувач вводить тему, опис звернення (може виникнути <font color="red">InvalidDataException</font>), за потреби прикладає зображення (може виникнути <font color="red">InvalidFileException</font>) <br> 6. Система надсилає звернення до скриньки підтримки адміністратора <br> 7. Система сповіщає адміністратора про звернення користувача <br> 8. Система сповіщає користувача про створення звернення <br> 9. Адміністратор оброблює звернення користувача |
