...
У цьому документі розглянуто основні визначення, які використовуються під час аналізу предметної області, підходи та способи вирішення в галузі систем управління проєктами. Також буде проведено порівняльний аналіз існуючих аналогів системи ProMan для управління проєктами, таких як GitHub Projects, Trello, та інші, на основі критеріїв FURPS, щоб визначити їхні плюси та мінуси на основі відгуків користувачів.
